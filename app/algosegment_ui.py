...
class Ui_MainWindow(object):
    def setupUi(self, AgloSegment):
        ...
        self.setup_region_growing_tab()
        self.setup_agglomerative_clustering_tab()
        self.setup_k_means_tab()
        self.setup_mean_shift_tab()
        self.setup_thresholding_tab()
        self.setup_global_thresholds_tab()
    ...
    def setup_mean_shift_tab(self):
        self.mean_shift_tab = QtWidgets.QWidget()
        self.mean_shift_tab.setObjectName("mean_shift_tab")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.mean_shift_tab)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.horizontalLayout_26 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_26.setObjectName("horizontalLayout_26")
        self.mean_shift_input = QtWidgets.QFrame(self.mean_shift_tab)
        ...
        self.mean_shift_output = QtWidgets.QFrame(self.mean_shift_tab)
        ...
        self.mean_shift_window_size_label = QtWidgets.QLabel(self.mean_shift_tab)
        ...
        self.mean_shift_window_size_spinbox = QtWidgets.QSpinBox(self.mean_shift_tab)
        ...
        self.mean_shift_sigma_label = QtWidgets.QLabel(self.mean_shift_tab)
        ...
        self.mean_shift_sigma_spinbox = QtWidgets.QSpinBox(self.mean_shift_tab)
        ...
        self.mean_shift_threshold_label = QtWidgets.QLabel(self.mean_shift_tab)
        ...
        self.mean_shift_threshold_spinbox = QtWidgets.QSpinBox(self.mean_shift_tab)
        ...
        self.apply_mean_shift = QtWidgets.QPushButton(self.mean_shift_tab)
        self.apply_mean_shift.setObjectName("apply_mean_shift")
        self.mean_shift_LUV_conversion = QtWidgets.QCheckBox(self.k_means_tab)
        ...
        self.tabWidget.addTab(self.mean_shift_tab, "")

    def setup_region_growing_tab(self):
        self.region_growing_tab = QtWidgets.QWidget()
        self.region_growing_tab.setObjectName("region_growing_tab")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.region_growing_tab)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.horizontalLayout_14 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_14.setObjectName("horizontalLayout_14")
        self.region_growing_input = QtWidgets.QFrame(self.region_growing_tab)
        ...
        self.region_growing_output = QtWidgets.QFrame(self.region_growing_tab)
        ...
        self.region_growing_threshold = QtWidgets.QLabel(self.region_growing_tab)
        ...
        self.region_growing_threshold_slider = QtWidgets.QDoubleSpinBox(
            self.region_growing_tab
        )
        ...
        self.window_size_label = QtWidgets.QLabel(self.region_growing_tab)
        self.window_size_label.setObjectName("window_size_label")
        self.window_size_spinbox = OddSpinBox(self.region_growing_tab)
        ...
        self.reset_region_growing = QtWidgets.QPushButton(self.region_growing_tab)
        self.reset_region_growing.setObjectName("Reset")
        self.apply_region_growing = QtWidgets.QPushButton(self.region_growing_tab)
        ...
        self.tabWidget.addTab(self.region_growing_tab, "")

    def setup_agglomerative_clustering_tab(self):
        self.agglomerative_clustering_tab = QtWidgets.QWidget()
        self.agglomerative_clustering_tab.setObjectName("agglomerative_clustering_tab")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.agglomerative_clustering_tab)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.horizontalLayout_18 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_18.setObjectName("horizontalLayout_18")
        self.agglomerative_input = QtWidgets.QFrame(self.agglomerative_clustering_tab)
        ...
        self.agglomerative_output = QtWidgets.QFrame(self.agglomerative_clustering_tab)
        ...
        self.agglo_num_of_clusters_label = QtWidgets.QLabel(
            self.agglomerative_clustering_tab
        )
        ...
        self.agglo_num_of_clusters_spinBox = QtWidgets.QSpinBox(
            self.agglomerative_clustering_tab
        )
        ...
        self.initial_num_of_clusters_label = QtWidgets.QLabel(
            self.agglomerative_clustering_tab
        )
        ...
        self.initial_num_of_clusters_spinBox = QtWidgets.QSpinBox(
            self.agglomerative_clustering_tab
        )
        ...
        self.agglo_elapsed_time = QtWidgets.QLabel(self.agglomerative_clustering_tab)
        ...
        self.downsampling = QtWidgets.QCheckBox(self.agglomerative_clustering_tab)
        self.downsampling.setObjectName("downsampling")
        self.agglo_scale_factor = QtWidgets.QSpinBox(self.agglomerative_clustering_tab)
        ...
        self.distance_calculation_method_label = QtWidgets.QLabel(
            self.agglomerative_clustering_tab
        )
        self.distance_calculation_method_label.setObjectName(
            "distance_calculation_method_label"
        )
        self.distance_calculation_method_combobox = QtWidgets.QComboBox(
            self.agglomerative_clustering_tab
        )
        ...
        self.apply_agglomerative = QtWidgets.QPushButton(
            self.agglomerative_clustering_tab
        )
        ...
        self.tabWidget.addTab(self.agglomerative_clustering_tab, "")

    def setup_k_means_tab(self):
        self.k_means_tab = QtWidgets.QWidget()
        self.k_means_tab.setObjectName("k_means_tab")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.k_means_tab)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.horizontalLayout_17 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_17.setObjectName("horizontalLayout_17")
        self.k_means_input = QtWidgets.QFrame(self.k_means_tab)
        ...
        self.k_means_output = QtWidgets.QFrame(self.k_means_tab)
        ...
        self.n_clusters_label = QtWidgets.QLabel(self.k_means_tab)
        self.n_clusters_label.setObjectName("n_clusters_label")
        self.horizontalLayout_20.addWidget(self.n_clusters_label)
        self.n_clusters_spinBox = QtWidgets.QSpinBox(self.k_means_tab)
        ...
        self.k_means_max_iterations_label = QtWidgets.QLabel(self.k_means_tab)
        ...
        self.k_means_max_iteratation_spinBox = QtWidgets.QSpinBox(self.k_means_tab)
        ...
        self.spatial_segmentation = QtWidgets.QCheckBox(self.k_means_tab)
        ...
        self.spatial_segmentation_weight_label = QtWidgets.QLabel(self.k_means_tab)
        ...
        self.spatial_segmentation_weight_spinbox = QtWidgets.QDoubleSpinBox(
            self.k_means_tab
        )
        ...
        self.centroid_optimization = QtWidgets.QCheckBox(self.k_means_tab)
        self.centroid_optimization.setObjectName("Centroid_Optimization")
        self.centroid_optimization.setChecked(True)
        self.k_means_LUV_conversion = QtWidgets.QCheckBox(self.k_means_tab)
        ...
        self.apply_k_means = QtWidgets.QPushButton(self.k_means_tab)
        ...
        self.tabWidget.addTab(self.k_means_tab, "")

    def setup_global_thresholds_tab(self):
    ...
    def setup_thresholding_tab(self):
        self.thresholding_tab = QtWidgets.QWidget()
        self.thresholding_tab.setObjectName("thresholding_tab")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.thresholding_tab)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.horizontalLayout_25 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_25.setObjectName("horizontalLayout_25")
        self.thresholding_input = QtWidgets.QFrame(self.thresholding_tab)
        ...
        self.thresholding_output = QtWidgets.QFrame(self.thresholding_tab)
        ...
        self.thresholding_type = QtWidgets.QLabel(self.thresholding_tab)
        self.thresholding_type.setObjectName("thresholding_type")
        self.horizontalLayout_32.addWidget(self.thresholding_type)
        self.thresholding_comboBox = QtWidgets.QComboBox(self.thresholding_tab)
        ...
        self.local_checkbox = QtWidgets.QCheckBox(self.thresholding_tab)
        ...
        self.global_checkbox = QtWidgets.QCheckBox(self.thresholding_tab)
        ...
        self.separability_measure = QtWidgets.QLabel(self.thresholding_tab)
        ...
        self.otsu_step_label = QtWidgets.QLabel(self.thresholding_tab)
        self.otsu_step_label.setObjectName("otsu_step_label")
        self.horizontalLayout_38.addWidget(self.otsu_step_label)
        self.otsu_step_spinbox = QtWidgets.QSpinBox(self.thresholding_tab)
        ...
        self.number_of_thresholds = QtWidgets.QLabel(self.thresholding_tab)
        self.number_of_thresholds.setObjectName("number_of_modes")
        self.horizontalLayout_33.addWidget(self.number_of_thresholds)
        self.number_of_thresholds_slider = QtWidgets.QSlider(self.thresholding_tab)
        ...
        self.apply_thresholding = QtWidgets.QPushButton(self.thresholding_tab)
        ...
        self.tabWidget.addTab(self.thresholding_tab, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.region_growing_tab),
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.agglomerative_clustering_tab),
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.k_means_tab),
            _translate("MainWindow", "K-Means"),
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.mean_shift_tab),
            _translate("MainWindow", "Mean Shift"),
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.thresholding_tab),
            _translate("MainWindow", "Thresholding"),
        )
        self.tabWidget.setTabText(
